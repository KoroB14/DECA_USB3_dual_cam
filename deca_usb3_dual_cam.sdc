...
#OV5642 camera clock
set PCLK_FREQ "96MHz"
create_clock -name {PCLK_cam_r} -period $PCLK_FREQ [get_ports {PCLK_cam_r}]
create_clock -name {virt_clk_cam_r} -period $PCLK_FREQ
create_clock -name {PCLK_cam_l} -period $PCLK_FREQ [get_ports {PCLK_cam_l}]
create_clock -name {virt_clk_cam_l} -period $PCLK_FREQ
set CAM_DATA_DELAY 2.500

derive_clock_uncertainty

set_clock_groups -exclusive -group [get_clocks {clk_usb virt_clk_usb}]
set_clock_groups -exclusive -group [get_clocks {PCLK_cam_r virt_clk_cam_r}]
set_clock_groups -exclusive -group [get_clocks {PCLK_cam_l virt_clk_cam_l}]  
set_clock_groups -asynchronous -group [get_clocks {PCLK_cam_r}] -group [get_clocks {PCLK_cam_l}] -group [get_clocks {clk_usb}] -group [get_clocks {clk_50}] 
...
set_output_delay -clock virt_clk_usb -max [expr $CLKBs_max + $tSUb + $BDb_max - $CLKBd_min] [get_ports {DMA0_Address[*]}]
...
set_output_delay -clock virt_clk_usb -min [expr $CLKBs_min - $tHb + $BDb_min - $CLKBd_max] [get_ports {DMA0_Address[*]}]
...
set_input_delay -add_delay -min -clock_fall -clock [get_clocks {virt_clk_cam_r}]  [expr $CLKAs_min + $tCOa_min + $BDa_min - $CLKAd_max] [get_ports {HREF_cam_r}]
set_input_delay -add_delay -min -clock_fall -clock [get_clocks {virt_clk_cam_r}]  [expr $CLKAs_min + $tCOa_min + $BDa_min - $CLKAd_max] [get_ports {VSYNC_cam_r}]
set_input_delay -add_delay -min -clock_fall -clock [get_clocks {virt_clk_cam_r}]  [expr $CLKAs_min + $tCOa_min + $BDa_min - $CLKAd_max] [get_ports {data_cam_r[*]}]
set_input_delay -add_delay -max -clock_fall -clock [get_clocks {virt_clk_cam_r}]  [expr $CLKAs_max + $tCOa_max + $BDa_max - $CLKAd_min] [get_ports {HREF_cam_r}]
set_input_delay -add_delay -max -clock_fall -clock [get_clocks {virt_clk_cam_r}]  [expr $CLKAs_max + $tCOa_max + $BDa_max - $CLKAd_min] [get_ports {VSYNC_cam_r}]
set_input_delay -add_delay -max -clock_fall -clock [get_clocks {virt_clk_cam_r}]  [expr $CLKAs_max + $tCOa_max + $BDa_max - $CLKAd_min] [get_ports {data_cam_r[*]}]

set_input_delay -add_delay -min -clock_fall -clock [get_clocks {virt_clk_cam_l}]  [expr $CLKAs_min + $tCOa_min + $BDa_min - $CLKAd_max] [get_ports {HREF_cam_l}]
set_input_delay -add_delay -min -clock_fall -clock [get_clocks {virt_clk_cam_l}]  [expr $CLKAs_min + $tCOa_min + $BDa_min - $CLKAd_max] [get_ports {VSYNC_cam_l}]
set_input_delay -add_delay -min -clock_fall -clock [get_clocks {virt_clk_cam_l}]  [expr $CLKAs_min + $tCOa_min + $BDa_min - $CLKAd_max] [get_ports {data_cam_l[*]}]
set_input_delay -add_delay -max -clock_fall -clock [get_clocks {virt_clk_cam_l}]  [expr $CLKAs_max + $tCOa_max + $BDa_max - $CLKAd_min] [get_ports {HREF_cam_l}]
set_input_delay -add_delay -max -clock_fall -clock [get_clocks {virt_clk_cam_l}]  [expr $CLKAs_max + $tCOa_max + $BDa_max - $CLKAd_min] [get_ports {VSYNC_cam_l}]
set_input_delay -add_delay -max -clock_fall -clock [get_clocks {virt_clk_cam_l}]  [expr $CLKAs_max + $tCOa_max + $BDa_max - $CLKAd_min] [get_ports {data_cam_l[*]}]


set_false_path -from [get_ports {rst_n}] 
set_false_path -to [get_ports {sioc}]
set_false_path -to [get_ports {siod}]
set_false_path -to [get_ports {on_off_cam_r}]
set_false_path -to [get_ports {on_off_cam_l}]
