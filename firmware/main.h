...
#define USB_CONSUMER_ENDPOINT1			(0x81)    /* EP 1 IN */
#define USB_CONSUMER_ENDPOINT1_SOCKET	(CY_U3P_UIB_SOCKET_CONS_1)
#define USB_CONSUMER_ENDPOINT2			(0x82)    /* EP 1 IN */
#define USB_CONSUMER_ENDPOINT2_SOCKET	(CY_U3P_UIB_SOCKET_CONS_2)
#define USB_PRODUCER_ENDPOINT			(0x02)    /* EP 2 OUT */
#define USB_PRODUCER_ENDPOINT_SOCKET	(CY_U3P_UIB_SOCKET_PROD_2)

#define GPIF_PRODUCER_SOCKET1			(CY_U3P_PIB_SOCKET_0)
#define GPIF_PRODUCER_SOCKET2			(CY_U3P_PIB_SOCKET_1)
#define GPIF_CONSUMER_SOCKET			(CY_U3P_PIB_SOCKET_2)
